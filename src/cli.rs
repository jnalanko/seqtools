        ...
        .subcommand(
            ...
            Command::new("extract-reads")
                ...
                .arg(Arg::new("rank")
                    .short('r')
                    .long("rank")
                    .help("Can be given multiple times (e.g. -r 4 -r 6).")
                    .conflicts_with("name")
                ...
                .arg(Arg::new("name")
                    .short('a')
                    .long("name")
                    .help("Can be given multiple times. Name is the part of the header that comes before the first space character.")
                    .conflicts_with("rank")
                    .action(ArgAction::Append) // Can have multiple
                )
        )
